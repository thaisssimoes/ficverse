      ...
      <div className={styles.page}>
        <header className={styles.header}>
          ...
          <nav className={styles.toc}>
            <a href="#normal" className={styles.tocLink}>História normal</a>
            <a href="#interativa" className={styles.tocLink}>História interativa</a>
            <a href="#dicas" className={styles.tocLink}>Dicas gerais</a>
          </nav>
        </header>
        ...
        <Section id="interativa" title="Publicando uma história interativa">
          <p className={styles.sectionIntro}>
            ...
            histórias de inserção de leitor ou narrativas
            personalizadas.
          </p>
          ...
          <Step number="1" title="Ative o modo interativo">
            <p>
              ...
              ativar ou desativar o modo a qualquer momento. O sistema gerencia as 
              variáveis e pode ativar ou desativar o modo a qualquer momento.
            </p>
          </Step>
          ...
          <Step number="3" title="Use as variáveis nos capítulos">
            ...
            <p>
              Depois que o leitor responder às perguntas, o texto renderizado
              ficará assim:
            </p>
            <div className={styles.example}>
              <p>
